...
urlpatterns = [
    ...
    path('create_question_title/<str:article_id>', views.create_question_type_title, name='create_question_type_title'),
    path('create_question/', views.create_question, name='create_question'),
    path('choose_best/<str:key_word>/', views.choose_best_article, name='choose_best_article'),
